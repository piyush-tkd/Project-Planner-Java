...
public class NlpConfigService {
    ...
    private void loadAndApplyConfig() {
        try {
            List<String> chain = getListValue("strategy_chain",
                    List.of("DETERMINISTIC", "RULE_BASED", "LOCAL_LLM", "CLOUD_LLM"));
            ...
            engine.configure(List.of("DETERMINISTIC", "RULE_BASED", "LOCAL_LLM", "CLOUD_LLM"), 0.75);
        }
    }
