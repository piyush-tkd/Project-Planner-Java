...
const PAGE_KEYS = [
 ...
 // ── Workspace
 { key: 'org_settings',          label: 'Admin Settings',         group: 'Workspace' },
 { key: 'smart_mapping_admin',   label: 'Smart Mapping',          group: 'Workspace' },
 { key: 'changelog_admin',       label: 'Changelog Admin',        group: 'Workspace' },
 { key: 'custom_fields_admin',   label: 'Custom Fields Admin',    group: 'Workspace' },
 { key: 'smtp_settings',         label: 'SMTP Email Settings',    group: 'Workspace' },
 { key: 'notification_schedule', label: 'Notification Schedule',  group: 'Workspace' },
 { key: 'azure_devops_settings', label: 'Azure DevOps',           group: 'Workspace' },
 { key: 'settings',              label: 'Settings (sub)',         group: 'Workspace' },
 { key: 'jira_resource_mapping', label: 'Resource Mapping',       group: 'Workspace' },
 { key: 'jira_release_mapping',  label: 'Release Mapping',        group: 'Workspace' },
 { key: 'sidebar_order',         label: 'Sidebar Order',          group: 'Workspace' },
 { key: 'nlp_settings',          label: 'NLP Settings',           group: 'Workspace' },
 { key: 'nlp_optimizer',         label: 'NLP Optimizer',          group: 'Workspace' },
 { key: 'feedback_hub',          label: 'Feedback Hub',           group: 'Workspace' },
 { key: 'error_log',             label: 'Error Log',              group: 'Workspace' },
