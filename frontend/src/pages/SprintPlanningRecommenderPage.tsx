            ...
            return (
              <SimpleGrid cols={4} mb="md">
                ...
                <Box style={{ textAlign: 'center' }}>
                  ...
                  <Text fw={800} size="xl" style={{ color: DEEP_BLUE }}>
                ...
                <Box style={{ textAlign: 'center' }}>
                  ...
                  <Text fw={800} size="xl" style={{ color: utilization > 1.0 ? '#EF4444' : DEEP_BLUE }}>
    ...
    <Stack>
      ...
      <Group justify="space-between" align="flex-start">
        <Group gap="sm">
          ...
          <Box>
            <Title order={2}>Sprint Planning Recommender</Title>
      ...
      {allPods.length > 0 && activeSprint && (
        <SimpleGrid cols={4}>
          ...
          >
            ...
            <Text fw={800} size="xl" style={{ color: DEEP_BLUE }}>{allPods.length}</Text>
            {jiraOnlyCount > 0 && (
