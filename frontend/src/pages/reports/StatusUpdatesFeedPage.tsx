...
import {
 IconPlus, IconTrash, IconRefresh, IconAlertTriangle,
...
export default function StatusUpdatesFeedPage() {
 ...
 <Text size="xl" fw={700} c="teal" style={{ }}>{greenCount}</Text>
 <Text size="xs" c="dimmed" style={{ }}>Green</Text>
 </Card>
 <Card withBorder radius="md" p="sm" style={{ textAlign: 'center' }}>
 <ThemeIcon size={32} color="orange" variant="light" mx="auto" mb={4}>
 <IconAlertTriangle size={18} />
 </ThemeIcon>
 <Text size="xl" fw={700} c="orange" style={{ }}>{amberCount}</Text>
 <Text size="xs" c="dimmed" style={{ }}>Amber</Text>
 </Card>
 <Card withBorder radius="md" p="sm" style={{ textAlign: 'center' }}>
 <ThemeIcon size={32} color="red" variant="light" mx="auto" mb={4}>
 <IconCircleX size={18} />
 </ThemeIcon>
 <Text size="xl" fw={700} c="red" style={{ }}>{redCount}</Text>
 <Text size="xs" c="dimmed" style={{ }}>Red</Text>
 </Card>
 </SimpleGrid>
 ...
 <Group gap="xs" mb={2}>
 <Text
 size="sm" fw={600} style={{cursor: 'pointer', color: DEEP_BLUE }}
 onClick={() => navigate(`/projects/${u.projectId}`)}
 >
 {u.projectName}
 </Text>
 {u.author && (
 <Text size="xs" c="dimmed" style={{ }}>by {u.author}</Text>
 )}
 <Text size="xs" c="dimmed" style={{ }}>
 {new Date(u.createdAt).toLocaleDateString()}
 </Text>
 </Group>
 <Text size="sm" style={{ }}>{u.summary}</Text>
 {u.whatDone && (
 <Text size="xs" mt={4} style={{ }}>
 <strong>Done:</strong> {u.whatDone}
 </Text>
 )}
 {u.whatsNext && (
 <Text size="xs" mt={2} style={{ }}>
 <strong>Next:</strong> {u.whatsNext}
 </Text>
 )}
 {u.blockers && (
 <Text size="xs" mt={2} c="red" style={{ }}>
