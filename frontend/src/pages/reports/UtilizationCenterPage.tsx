...
import { AQUA, COLOR_BLUE, COLOR_BLUE_LIGHT, COLOR_ERROR, COLOR_ERROR_DEEP, COLOR_ERROR_STRONG, COLOR_GREEN_DARK, COLOR_GREEN_LIGHT, COLOR_ORANGE, COLOR_ORANGE_ALT, COLOR_ORANGE_DARK, COLOR_SUCCESS, COLOR_TEAL, COLOR_VIOLET_ALT, COLOR_WARNING, DEEP_BLUE, SURFACE_ERROR, SURFACE_SUBTLE, SURFACE_SUCCESS, SURFACE_WARNING, TEXT_DIM, DEEP_BLUE_TINTS, TEXT_MUTED} from '../../brandTokens';
...
function SlackBufferTab({
 ...
 styles={{ title: {color: dark ? '#fff' : DEEP_BLUE, fontWeight: 700 } }}>
 {selectedCell && (
 <Stack gap="md">
 <div>
