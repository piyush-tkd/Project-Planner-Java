...
import { COLOR_ERROR_DEEP, COLOR_ORANGE_DARK, DEEP_BLUE, SURFACE_ERROR_LIGHT, SURFACE_ORANGE, SURFACE_SELECTED } from '../../brandTokens';
...
export default function CapacityForecastPage() {
 ...
 <Group gap="sm">
 <Text fw={700} size="sm" style={{ }}>{pod.podName}</Text>
 <Badge
 ...
 <Text fw={600} mb="sm" size="sm" style={{ }}>Full Forecast Table</Text>
