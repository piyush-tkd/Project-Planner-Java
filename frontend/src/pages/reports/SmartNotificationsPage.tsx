...
import { AQUA_TINTS, BORDER_SOFT, CHART_COLORS, COLOR_AMBER, COLOR_ERROR, COLOR_ERROR_LIGHT, COLOR_GREEN_LIGHT, DARK_MUTED, DARK_TEXT, DEEP_BLUE, GRAY_300, GRAY_400, SHADOW, SURFACE_BLUE} from '../../brandTokens';
...
const SmartNotificationsPage: React.FC = () => {
 ...
 <Card.Section inheritPadding py="md">
 {alerts.length === 0 ? (
 <Alert icon={<IconChecklist size={16} />} title="All clear!" color="green" style={{ }}>
