      ...
      <Group gap="md" wrap="nowrap">
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <Group gap={6} align="baseline" wrap="nowrap">
            <Text fw={800}
              style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE, lineHeight: 1.1, fontSize: '1.75rem' }}>
              {value}
            </Text>
...
function DrillDrawer({ opened, onClose, title, breakdowns }: {
  ...
  return (
    <Drawer opened={opened} onClose={onClose} title={title} position="right"
      ...
      styles={{ title: { fontFamily: FONT_FAMILY, fontWeight: 700, color: DEEP_BLUE } }}>
      <Stack gap="sm">
        {/* Summary row */}
        <Group gap="lg">
          <Paper withBorder p="xs" radius="sm" style={{ borderLeft: `3px solid ${AQUA}` }}>
            ...
            <Text fw={700} size="lg" style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE }}>{totalCount}</Text>
          </Paper>
          {hasSp && (
            <Paper withBorder p="xs" radius="sm" style={{ borderLeft: '3px solid #7C3AED' }}>
              ...
              <Text fw={700} size="lg" style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE }}>{totalSp}</Text>
            </Paper>
          )}
          {hasHours && (
            <Paper withBorder p="xs" radius="sm" style={{ borderLeft: '3px solid #059669' }}>
              ...
              <Text fw={700} size="lg" style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE }}>{totalHrs.toFixed(1)}</Text>
            </Paper>
          )}
        </Group>
