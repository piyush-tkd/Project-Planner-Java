...
import { AQUA_HEX, DEEP_BLUE_HEX, AQUA_TINTS, DEEP_BLUE, DEEP_BLUE_TINTS, GRAY_200} from '../../brandTokens';
...
export default function CrossTeamDependencyPage() {
 ...
 const { data: _gapData, isLoading: loadingGapData } = useCapacityGap('hours');
