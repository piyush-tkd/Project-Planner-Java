    ...
    <UnstyledButton onClick={onClick} style={{ textAlign: 'left', width: '100%' }}>
      ...
      >
        ...
        <Group align="baseline" gap={8}>
          <Text size="2rem" fw={800} style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE, lineHeight: 1.1 }}>
...
function BenchmarkTable({ metricKey, currentLevel }: { metricKey: string; currentLevel: string }) {
  ...
  return (
    <Paper withBorder radius="sm" p="sm" mt="md" style={{ backgroundColor: AQUA_TINTS[10] }}>
      <Text size="xs" fw={700} mb="xs" style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE }}>
...
function DetailTable({ details, columns, jiraBaseUrl }: {
  ...
  return (
    <Table striped highlightOnHover withTableBorder styles={{
      th: { fontFamily: FONT_FAMILY, fontSize: 11, color: DEEP_BLUE, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.03em', padding: '8px 10px' },
  ...
  return (
    <Stack gap="md">
      ...
      <ChartCard title="Month-by-Month DORA Scorecard" minHeight={200}>
        <ScrollArea>
          <Table withTableBorder withColumnBorders styles={{
            th: { fontFamily: FONT_FAMILY, fontSize: 11, color: DEEP_BLUE, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.03em', padding: '10px 12px', textAlign: 'center' },
          ...
          return (
            <Paper key={card.month} withBorder radius="md" p="md" style={{ borderLeft: `4px solid ${overallColor}`, boxShadow: SHADOW.card }}>
              <Group justify="space-between" mb="sm">
                <Text size="sm" fw={800} style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE }}>{card.month}</Text>
                <Group gap={4}>
      ...
      case 'deploy': {
        ...
        return (
          <Stack gap="md">
            ...
            {details.length > 0 && (
              <>
                <Text size="sm" fw={600} mt="sm" style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE }}>
        ...
        return (
          <Stack gap="md">
            ...
            {monthDrillMetric === 'deploymentFrequency' && metric.releases && metric.releases.length > 0 && (
              <Paper withBorder radius="sm" p="sm">
                <Text size="xs" fw={600} mb={4} style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE }}>Releases this month ({metric.releases.length})</Text>
            ...
            <Paper withBorder radius="sm" p="sm" style={{ backgroundColor: AQUA_TINTS[10] }}>
              <Text size="xs" fw={700} mb={4} style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE }}>Month Summary</Text>
              <Group gap="lg">
    ...
    >
      ...
      {data.upcoming.length > 0 && (
        <ChartCard title="Upcoming Releases" minHeight={100}>
          <Table striped highlightOnHover withTableBorder withColumnBorders styles={{
            th: { fontFamily: FONT_FAMILY, fontSize: 12, color: DEEP_BLUE, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.03em' },
      ...
      <Drawer
        ...
        onClose={closeDrill}
        title={
          <Text fw={700} size="lg" style={{ fontFamily: FONT_FAMILY, color: DEEP_BLUE }}>
            {drawerTitle}
          </Text>
        }
        position="right"
