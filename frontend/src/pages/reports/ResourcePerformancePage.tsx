...
import {
 ...
 Stack, SimpleGrid, ScrollArea, SegmentedControl,
 Tooltip, Modal, Badge, Box, UnstyledButton, Avatar, Skeleton
} from '@mantine/core';
...
export default function ResourcePerformancePage() {
 ...
 <Table.Thead>
 <Table.Tr>
 <Table.Th style={{ width: 36, position: 'sticky', left: 0, background: 'var(--pp-bg)', zIndex: 1 }}>
 #
 </Table.Th>
 <Table.Th style={{ minWidth: 170, position: 'sticky', left: 36, background: 'var(--pp-bg)', zIndex: 1 }}>
 Resource
 </Table.Th>
 ...
 <Text size="xs" fw={600} c={AQUA} style={{ lineHeight: 1.2, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
 {r.resourceName}
 </Text>
 ...
 <Table.Td ta="center" style={{ background: isDark ? 'rgba(255,255,255,0.04)' : SURFACE_SUBTLE }}>
 ...
 <Table.Td ta="center" style={{ background: isDark ? '#2c2e33' : GRAY_100 }}>
 ...
 <Text size="xs" c="dimmed">
 {drillPeriod.label} · Issues & Worklogs
 </Text>
 </div>
 </Group>
 }
 ...
 <Table.Td>
 <Badge size="xs" style={{ backgroundColor: ts.bg, color: ts.text }}>
 {issue.issueType}
 </Badge>
 </Table.Td>
 <Table.Td>
 ...
 {issue.hoursLogged > 0 ? `${issue.hoursLogged.toFixed(1)}h` : '\u2014'}
 </Text>
 </Table.Td>
 </Table.Tr>
 );
