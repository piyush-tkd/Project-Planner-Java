...
import { AQUA_HEX, AQUA, COLOR_ORANGE_ALT, DARK_BG, DARK_BORDER, DEEP_BLUE, GRAY_100, SHADOW } from '../../brandTokens';
...
import { useCapacityDemandSummary, useHiringForecast } from '../../api/reports';
...
export default function ResourceForecastPage() {
 ...
 const { data: _projects, isLoading: projectsLoading, error: projectsError } = useProjects();
