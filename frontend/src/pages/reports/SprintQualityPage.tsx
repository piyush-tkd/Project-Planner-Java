...
import {
 ...
 ActionIcon, Tooltip, SegmentedControl, useComputedColorScheme
} from '@mantine/core';
import {
...
import { AQUA_HEX, COLOR_ERROR, COLOR_GREEN, COLOR_WARNING, DEEP_BLUE } from '../../brandTokens';
...
export default function SprintQualityPage() {
 ...
 <div>
 <Title order={2} style={{color: isDark ? '#fff' : DEEP_BLUE }}>Sprint Quality</Title>
