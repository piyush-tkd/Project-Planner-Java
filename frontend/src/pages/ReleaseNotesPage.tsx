...
function ReleaseSection({
 ...
 <>
 {/* ── Stats row ──────────────────────────────────────────── */}
 <SimpleGrid cols={{ base: 2, sm: 4 }} p="md" style={{ borderBottom: isDark ? '1px solid #373A40' : '1px solid #e9ecef' }}>
 <Box ta="center">
 <Text size="xs" c="dimmed" fw={600} tt="uppercase">Total Issues</Text>
 <Text fw={700} size="xl" style={{ color: isDark ? '#fff' : DEEP_BLUE }}>{metrics.totalIssues}</Text>
 </Box>
 <Box ta="center">
