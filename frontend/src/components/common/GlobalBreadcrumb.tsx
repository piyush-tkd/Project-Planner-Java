...
const SEC = {
  ...
  STRATEGY:  { label: 'Portfolio', path: '/projects' } as Crumb,
...
const ROUTE_TRAILS: Record<string, Crumb[]> = {
  ...
  '/projects':          [H, SEC.STRATEGY, { label: 'Projects',           path: '/projects' }],
  '/projects/:id':      [H, SEC.STRATEGY, { label: 'Projects',           path: '/projects' }, { label: '…' }],
  '/pods':              [H, SEC.STRATEGY, { label: 'PODs',               path: '/pods' }],
  '/pods/:id':          [H, SEC.STRATEGY, { label: 'PODs',               path: '/pods' },     { label: '…' }],
