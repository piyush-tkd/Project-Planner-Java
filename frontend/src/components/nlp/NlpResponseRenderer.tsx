...
export function NumberedItemList({ data, onNavigate }: { data: Record<string, unknown>; onNavigate: (route: string, entityName?: string) => void }) {
...
// ── NLP Result Card Component ────────────────────────────────────────────────

export function NlpResultCard({
  result,
  onNavigate,
  onNavigateWithToast,
  onFormPrefill,
